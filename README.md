...
#2015.12.30-下一个版本计划将侧重面向局域分布式单点登陆及授权式登陆。应用场景诸如万维网服务群、社区群、大型校园\校园群、园区。作者正在征集建议。
#这个项目并没有停止维护，只是我最近太忙了。BETA版可能不会应用到BTS_PHP框架，可能依然有些乱，但它会依然来临。
#I'm so busy now!But I am still here.Beta will comming!
