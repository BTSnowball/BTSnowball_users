...
*/
$WHand=$WHanddir.'hand.php';
$WHandkeydo=$WBuHand.'keydo.php';
$WHandreg=$WHanddir.'handreg.php';
$WHandlogin=$WHanddir.'handlogin.php';
$WHandislogin=$WHanddir.'handislogin.php';